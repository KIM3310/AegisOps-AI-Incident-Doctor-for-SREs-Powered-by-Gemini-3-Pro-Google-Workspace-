...
Security support applies to the default branch and the latest released or documented deployment path for AegisOps. Experimental examples, local-only scripts, and archived demos are best-effort unless the README states otherwise.
